    ...
    <section class="lab-section">
      <div class="fun-photo-grid">
        <figure class="fun-grid-item">
          <img src="images/selfie-coffee.png" alt="Coffee in Brooklyn">
        ...
        <div class="image-column">
          <div class="sticky-images">
            <figure class="image-item">
              ...
              <figcaption class="image-caption">Big Ten Championship Celebration</figcaption>
            </figure>
          </div>
        </div>
      </div>
    ...
    <section class="lab-section">
      <div class="two-column-layout">
        <div class="content-column">
          ...
          <ul>
            <li>Daily activity tracking including steps, heart rate, and sleep quality</li>
            <li>Training metrics for running and cycling activities</li>
            <li>Recovery and stress level monitoring</li>
            <li>Custom data visualization using R and Python</li>
          </ul>
        </div>
        <div class="image-column">
          <div class="project-gallery">

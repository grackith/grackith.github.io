    ...
    <section class="lab-section">
      <div class="two-column-layout">
        ...
        <div class="content-column">
          ...
          <ul>
            <li><a href="projects.html#sim2real">Sim2Real: Virtualized mixed-traffic driving environments with human regulated RL agents</a></li>
            <li><a href="projects.html#unregulated-ped">Unregulated pedestrian behavior in mixed-traffic driving environments</a></li>
...
<!-- HFSM Lab -->
    ...
    <section class="lab-section">
      <div class="two-column-layout">
        ...
        <div class="image-column">
          <div class="project-gallery">
            <div class="gallery-images" id="csl-gallery" style="width: 100%; display: flex; overflow: hidden;">
              <figure style="flex: 0 0 100%; min-width: 100%; display: none; margin: 0; transition: opacity 0.3s ease;">
                <img 
                  src="images/temporal-dynamics-domeyer.png" 
                  alt="Drivers 'short-stop' as a type of nonverbal communication to vulnerable pedestrians. Spatiotemporal traces of mixed-traffic behavior helps identify mechanisms of informal interaction in shared spaces."
                ...
                <figcaption style="text-align: center; margin-top: 10px; font-size: 0.9rem; color: #666; font-style: italic;">
                  CSL Lab at University of Wisconsin-Madison
                </figcaption>
              </figure>
              <figure style="flex: 0 0 100%; min-width: 100%; display: none; margin: 0; transition: opacity 0.3s ease;">
                <img 
                  src="images/hfsm-csl.jpeg" 
                  alt="CSL and HFSM celebration"
                  style="width: 100%; height: auto; max-height: 500px; object-fit: contain;"
                >
                <figcaption style="text-align: center; margin-top: 10px; font-size: 0.9rem; color: #666; font-style: italic;">
            ...
            <div class="gallery-nav" id="csl-nav" style="display: flex; justify-content: center; gap: 0.5rem; margin-top: 1rem;">

    ...
    <div class="two-column-layout">
      ...
      <div class="content-column">
        <div class="intro-box">
          ...
          <div class="intro-box-content" style="--n:604;">
            My research explores the role of the built environment as a platform for safe and equitable negotiations between diverse and dynamic sets of road users. Specifically, my dissertation work builds computational models that capture locale-specific context between motorized and nonmotorized agents in mixed-traffic driving environments. The goal is to develop <span class="italic">fair</span>, <span class="italic">safe</span>, and <span class="italic">shareable</span> representations of these real-time negotiations in shared urban spaces. This can inform the design of more inclusive transportation infrastructure, connected technologies, and automated systems for complex urban environments.
          </div>
        </div>

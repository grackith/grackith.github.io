...
```{=html}
    <!-- Sim2Real Project -->
    <section class="lab-section" style="max-width: 1200px; margin: 0 auto; padding: 20px;">
      <article style="margin-bottom: 40px;">
        <h3 style="font-size: 1.5rem; margin-bottom: 20px; color: #333;">
          Sim2Real: Virtualized mixed-traffic driving environments with human regulated RL agents 
          <a href="https://github.com/grackith/tangle-town" target="_blank" style="color: #333; font-size: 0.8em; margin-left: 10px; text-decoration: none;">
            <i class="fab fa-github"></i>
          </a>
        </h3>
        ...
        <div style="display: flex; flex-direction: column; gap: 30px;">
          ...
          <div style="width: 100%;">
            <img 
              src="videos/models-of-pedestrians_captured-motion.mp4" 
              alt="Video placeholder for pre-captured motion casting process"
              style="width: 100%; max-height: 500px; object-fit: contain;"
            >
            <p style="text-align: center; margin-top: 10px; font-size: 0.9rem; color: #666; font-style: italic;">
              Pre-captured motion casting process (Video not available)
            </p>
          </div>
        </div>
      </article>
        ...
        <div class="image-column">
          <div class="project-gallery">
            <div class="gallery-images" id="cross-cultural-gallery">
              ...
              <figure>
                <img src="images/share-sharp2-mapping.png" alt="Cluster SHARE">
        ...
        <div class="image-column">
          <div class="project-gallery">
            <div class="gallery-images" id="ped-devices-gallery">
              <figure>
                <img src="images/ped-exp-estimates-v2.jpeg" alt="Pedestrian exposure estimates">
                <figcaption class="image-caption">Pedestrian exposure estimation results</figcaption>
              </figure>
              <figure>
                <img src="images/WB_subsetted_off_mapV2.jpeg" alt="Walking activity">

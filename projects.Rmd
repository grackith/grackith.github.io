...
<div class="main-wrapper">
  <div class="content-wrapper">
    <div class="intro-box">
     ...
     <div class="intro-box-content" style="--n:261;">My work is a mix of obervational and experimental methods. Safety in automation and road user behvior are underlying themes throughout my research, paired with an underlying question: <span class="italic">How can the built environment support safe and fair mixed-traffic negotiations?</span>
     </div>
    </div>
```
...
<section class="lab-section" style="padding-top: 40px; border-bottom: 2px solid #e0e0e0; padding-bottom: 40px; margin-bottom: 40px;">
  ...
  <!-- Visible Pedestrians Project -->
  <div style="margin-bottom: 50px;">
    <section class="project-section">
      <h3 id="visible-pedestrians">
      ...
      <figure style="margin-top: 30px; margin-bottom: 0;">
        ...
        <figcaption class="image-caption">
          Pedestrian detection system levels of detail demonstration
        </figcaption>
      </figure>
    </section>
  </div>
    ...
    <div class="image-column">
      <div style="display: flex; flex-direction: column; gap: 30px;">
        <figure style="margin: 0;">
          ...
          <figcaption class="image-caption">
            VR pedestrian navigation in South Lake Union, Seattle
          </figcaption>
        </figure>
        ...
        <figure style="margin: 0;">
          ...
          <figcaption class="image-caption">
            Redirected walking and lower body IK demonstration
          </figcaption>
        </figure>
      </div>
    </div>

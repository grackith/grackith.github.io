...
My work is a mix obervational and experimental methods. <em>Traffic safety</em> and <em> road user behavior</em> are underlying themes throughout my research, with an underlying question: how does the design of in- and out- vehicle traffic environments contribute to fair, safe, and <em>shared</em> urban spaces?</div>
    </div>

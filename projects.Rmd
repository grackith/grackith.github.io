...
<div class="main-wrapper">
  <div class="content-wrapper">
    <div class="intro-box">
     ...
     <div class="intro-box-content" style="--n:267;">My work is a mix of obervational and experimental methods. Safety in automation and road user behvior are underlying themes throughout my research, paired with an underlying question: <span class="italic">How can the built environment support safe and fair mixed-traffic negotiations?</span>
     </div>
    </div>
```

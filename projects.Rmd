  ...
  <div class="content-wrapper">
    <div class="intro-box">
      <div class="intro-box-title">
        <span class="emoji">👩‍💻</span>research
      </div>
      <div class="intro-box-content">
My work is a mix obervational and experimental methods. Common themes throughout my research is traffic safety and road user behavior, with an underlying research question: how does the design of in- and out- vehicle environments contribute to fair, safe, and <em>shared</em> urban spaces? 
      </div>
    </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 30px;">
        <figure style="margin: 0;">
          ...
          <figcaption class = "image-caption">
            Driver perspective of Strangetown, an inter-urban instantiation of Strangeland to investigate informal behavior among mixed-traffic road agents.</figcaption>
        </figure>
